...
class SchoolResourceIT {
    ...
    public static School createEntity(EntityManager em) {
        School school = new School().name(DEFAULT_NAME).adress(DEFAULT_ADRESS).emailDomain(DEFAULT_EMAIL_DOMAIN);
        return school;
    }
    ...
    public static School createUpdatedEntity(EntityManager em) {
        School school = new School().name(UPDATED_NAME).adress(UPDATED_ADRESS).emailDomain(UPDATED_EMAIL_DOMAIN);
        return school;
    }
    ...
    void createSchool() throws Exception {
        ...
        assertThat(testSchool.getAdress()).isEqualTo(DEFAULT_ADRESS);
        assertThat(testSchool.getEmailDomain()).isEqualTo(DEFAULT_EMAIL_DOMAIN);
    }
    ...
    void putNewSchool() throws Exception {
        ...
        updatedSchool.name(UPDATED_NAME).adress(UPDATED_ADRESS).emailDomain(UPDATED_EMAIL_DOMAIN);
        ...
        assertThat(testSchool.getAdress()).isEqualTo(UPDATED_ADRESS);
        assertThat(testSchool.getEmailDomain()).isEqualTo(UPDATED_EMAIL_DOMAIN);
    }
    ...
    void partialUpdateSchoolWithPatch() throws Exception {
        ...
        partialUpdatedSchool.name(UPDATED_NAME).adress(UPDATED_ADRESS);
    ...
    void fullUpdateSchoolWithPatch() throws Exception {
        ...
        partialUpdatedSchool.name(UPDATED_NAME).adress(UPDATED_ADRESS).emailDomain(UPDATED_EMAIL_DOMAIN);
